<template>
  <div>
    <div class="top_btn">
      <label for="popup_addfile" class="mainbtn mainbtn2" id="btn_new" @click="setFileUserOffice">新規作成</label>
    </div>
    ...
    <div class="search-form">
      <form>
        <ul class="form-list">
            ...
            <ul class="checklist">
              <li>
                <label class="checkset">
                  <input type="checkbox" v-model="search.office.enable" name="search_ctt" />
                  <svg
              ...
              <li>
                <label class="checkset">
                  <input type="checkbox" name="search_ctt" v-model="search.author.enable" />
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="49.85"
                    height="33.93"
          ...
          <li class="fli">
            <ul class="checklist">
              <li>
                <label class="checkset">
                  <input type="checkbox" name="search_ctt" v-model="search.date.enable" />
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="49.85"
                    height="33.93"
                ...
                <label class="dateset">
                  <input type="date" v-model="search.date.dateFrom" />
                </label>
                <span class="datetxt">～</span>
                <label class="dateset">
                  <input type="date" v-model="search.date.dateTo" />
                </label>
              </li>
            </ul>
          </li>
          <li class="fli">
            <ul class="checklist">
              <li>
                <label class="checkset">
                  <input v-model="material" value="guide" type="checkbox" name="search_ctt" />
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="49.85"
                    height="33.93"
              ...
              <li>
                <label class="checkset">
                  <input v-model="material" value="office" type="checkbox" name="search_ctt" />
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="49.85"
                    height="33.93"
              ...
              <li>
                <label class="checkset">
                  <input v-model="material" value="other" type="checkbox" name="search_ctt" />
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="49.85"
                    height="33.93"
          ...
          <li class="fli">
            <ul class="checklist">
              <li>
                <label class="checkset">
                  <input type="checkbox" name="search_ctt" v-model="search.keyword.enable" />
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="49.85"
                    height="33.93"
        ...
        <input type="submit" value="検索" class="mainbtn" @click.prevent="doSearch" />
      </form>
    </div>
    <!-- 検索条件追加 -->
        ...
        <ul class="flex">
          <li v-for="file in files" :key="file.id">
            ...
            <div for="popup_imgdtl" class="thumb">
              <label @click="selectFile(file.id)" for="popup_editfile" class="imgbox">
                <img :src="file.thumbnail" width="500" height="829" alt="イメージ" />
              </label>
              <div class="file_type">
...
<script>
import fileStore, { setSelectedId, setCurrentUser, setFileUserOffice, doSearch } from "../../stores/fileStore";
...
export default {
  ...
  computed: {
    ...
    searchFilter() {
      ...
      if (this.material.length > 0) search.material = this.material.join(",");
  ...
  methods: {
    ...
    setUser(){
     let user = { name : this.userInfo.name, office : this.userOffice.name};
     setCurrentUser(user);
    },
    setFileUserOffice(){
      let user = { name : this.userInfo.name, office : this.userOffice.name};
