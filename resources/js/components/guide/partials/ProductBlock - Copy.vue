      ...
      <li class="sec" v-for="(product, index) in products" :key="index">
        ...
        <div class="formctbox">
          <ul>
            ...
            <li>
              <input type="radio"  :name="'fontsize' + index" @click="disableFontSize(product.inscription)" v-model="product.inscription.font_size_enable" value="true" :id="'fontsize01' + index" class="disabled_on" />
